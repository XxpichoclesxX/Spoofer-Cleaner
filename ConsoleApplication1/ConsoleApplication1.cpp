...
int main()
{
    SetConsoleTitleA("Spoofer made by Alejandroelxd#6976");
    int choice;
menu:
...
\__    ___/____    ____  ____    /   _____/_____   ____   _____/ ____\___________ 
  ...
  |____|  (____  /\___  >____/  /_______  /   __/ \____/ \____/|__|  \___  >__|   
    ...
    cout << "3: Optimizador de pc (Funcionando!!)\n";
    ...
    reespoof:
        ...
        if (Option2 == 1)
        {
            ...
            Sleep(1500);
            ("CLS");
            //system("Wmic.exe /Namespace:\\root\\default Path SystemRestore Call CreateRestorePoint 'My Restore Point', 100, 12");
            //printf("Creando punto de restauracion...");
            //Sleep(2500);
            //string spoofer = "";//download link
